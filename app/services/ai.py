        ...
        key: [
            {
                ...
                "recommendation_text": (
                    "Нет истории за прошлые годы и нет текущих продаж для расчета спроса. "
                    "Данных для анализа пока мало, поэтому закупку по этой позиции нужно подтвердить вручную "
                    "или загрузить дополнительную историю."
                ),
                "data_status": "нет истории за прошлые годы",
                "risk": "Если закупать без подтвержденных продаж, высок риск излишка.",
            }
